from ipn.models.Lvc_Update_Skymap import Lvc_Update_Skymap

def create_lvc_update_skymap_from_message(message_json, message):
  Lvc_Update_Skymap.objects.create(
